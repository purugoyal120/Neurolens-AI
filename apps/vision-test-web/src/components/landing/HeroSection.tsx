    ...
    <div className="relative overflow-hidden bg-[#f8fafc] pt-[120px] pb-32">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          Revolutionizing Web Accessibility
        </motion.div>
        ...
        >
          The Web, <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-600">Personalized</span> for Every Vision.
        </motion.h1>
        ...
        >
          Neurolens AI uses advanced AI to dynamically adapt digital interfaces in real-time, 
          creating bespoke visual experiences for individuals with color blindness and visual impairments.
        </motion.p>
        ...
        >
          <Link to="/register" className="premium-btn px-10 py-5 text-lg flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-left">
          {[
            { icon: Eye, title: "Adaptive Colors", desc: "Real-time recoloring algorithms optimized for Protanopia, Deuteranopia, and Tritanopia.", color: "emerald" },
            { icon: Zap, title: "Zero Latency", desc: "Lightning-fast DOM mutations ensure seamless browsing without any noticeable delay.", color: "teal" },
            { icon: Shield, title: "Privacy First", desc: "Local processing means your vision profile and browsing history never leave your device.", color: "emerald" }
          ].map((feat, idx) => (
            <motion.div 
              key={idx}
