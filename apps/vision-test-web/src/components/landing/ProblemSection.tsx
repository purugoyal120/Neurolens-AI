    ...
    <div className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-500 max-w-3xl mx-auto font-medium">Over 300 million people globally experience some form of colour vision deficiency.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-3xl border border-slate-100 bg-slate-50 hover:bg-slate-100 transition-colors">
            ...
            <p className="text-slate-500 font-medium">Charts, graphs, and warning labels relying solely on colour become impossible to interpret.</p>
          </div>
          <div className="p-8 rounded-3xl border border-slate-100 bg-slate-50 hover:bg-slate-100 transition-colors">
