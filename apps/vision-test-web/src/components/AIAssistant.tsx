  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 w-14 h-14 bg-blue-500 rounded-full flex items-center justify-center shadow-lg shadow-blue-500/30 hover:scale-105 transition-transform z-40 ${isOpen ? 'hidden' : 'flex'}`}
      >
        ...
        <div className="fixed bottom-6 right-6 w-80 md:w-96 bg-white border border-slate-200 shadow-2xl rounded-2xl flex flex-col z-50 overflow-hidden animate-in slide-in-from-bottom-5 duration-300">
          <div className="bg-blue-500 p-4 flex justify-between items-center text-white">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-blue-100">Your Accessibility Copilot</p>
              </div>
            </div>
          ...
          <div className="p-4 border-t border-slate-100 bg-white">
            <div className="flex items-center gap-2">
              ...
              <button 
                onClick={handleSend}
                className="w-10 h-10 rounded-xl bg-blue-500 hover:bg-blue-600 text-white flex items-center justify-center transition-colors shadow-sm"
              >
