...
export const PricingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f8] font-sans selection:bg-emerald-100 selection:text-emerald-900 overflow-hidden relative">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-32">
        ...
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-8 duration-700">
          <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 mb-6 text-sm font-bold uppercase tracking-widest shadow-sm">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 mb-6 tracking-tight">
            Invest in <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-emerald-700">Clear Vision</span>
          </h1>
        ...
        <div className="flex justify-center mb-16 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-150">
          <div className="bg-white p-1.5 rounded-full border border-slate-200 shadow-sm flex items-center">
            ...
            <button 
              ...
              className={`px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300 flex items-center gap-2 ${isAnnual ? 'bg-emerald-500 text-white shadow-md shadow-emerald-500/20' : 'text-slate-500 hover:text-slate-800'}`}
            >
              Annually <span className={isAnnual ? 'bg-white/20 px-2 py-0.5 rounded-full text-xs' : 'bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full text-xs'}>Save 20%</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-slate-900 rounded-[2rem] p-8 border border-slate-700 shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 hover:-translate-y-2 relative group flex flex-col transform md:-translate-y-4">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-emerald-400 to-emerald-600 text-white px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest shadow-lg flex items-center gap-1.5">
            ...
            <Link to="/register?role=doctor" className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-emerald-400 to-emerald-600 text-white font-bold text-center mb-8 shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 hover:-translate-y-0.5 transition-all">
        ...
        <div className="mt-32 max-w-4xl mx-auto bg-gradient-to-r from-emerald-900 to-slate-900 rounded-[2rem] p-10 md:p-14 text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Link to="/onboarding" className="inline-flex items-center justify-center px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-white rounded-full font-bold text-lg transition-all shadow-lg hover:shadow-emerald-500/50 hover:scale-105 group">
